...
new15(A,A) :- B= 1, C>= 268435456, C=A, A>= 0, D= 268435455, new16(A,B,E).
new15(A,A) :- B= 0, C=< 268435455, C=A, A>= 0, D= 268435455, new16(A,B,E).
...
new5(A,A) :- B= 1, C>= 268435456, C=A, A>= 0, D= 268435455, new6(A,B,E).
new5(A,A) :- B= 0, C=< 268435455, C=A, A>= 0, D= 268435455, new6(A,B,E).
