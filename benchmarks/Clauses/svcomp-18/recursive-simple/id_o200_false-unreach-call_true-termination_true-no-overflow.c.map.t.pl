new20(A,B,C,A,B,C).
new18(A,B,C,D,E,F) :- G>= 201, G=B, B>= 0, H= 200, new20(A,B,C,D,E,F).
new18(A,B,C,D,E,F) :- G+ 1=< 200, G=B, B>= 0, H= 200, new20(A,B,C,D,E,F).
...
new6(A,B,C,D,E,F) :- G= 200, G=B, B>= 0, H= 200, new9(A,B,C,D,E,F).
