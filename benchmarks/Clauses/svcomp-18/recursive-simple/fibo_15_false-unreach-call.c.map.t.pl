new30(A,B,C,A,B,C).
new28(A,B,C,D,E,F) :- G>= 611, G=B, H= 610, new30(A,B,C,D,E,F).
new28(A,B,C,D,E,F) :- G+ 1=< 610, G=B, H= 610, new30(A,B,C,D,E,F).
...
new6(A,B,C,D,E,F) :- G= 610, G=B, H= 610, new15(A,B,C,D,E,F).
