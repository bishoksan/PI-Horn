new30(A,B,C,A,B,C).
new28(A,B,C,D,E,F) :- G= 75025, G=B, H= 75025, new30(A,B,C,D,E,F).
...
new6(A,B,C,D,E,F) :- G>= 75026, G=B, H= 75025, new15(A,B,C,D,E,F).
new6(A,B,C,D,E,F) :- G+ 1=< 75025, G=B, H= 75025, new15(A,B,C,D,E,F).
