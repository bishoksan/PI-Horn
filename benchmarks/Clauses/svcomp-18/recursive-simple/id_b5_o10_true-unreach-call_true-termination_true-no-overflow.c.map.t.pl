new26(A,B,C,A,B,C).
new24(A,B,C,D,E,F) :- G>= 11, G=B, H= 10, new26(A,B,C,D,E,F).
new24(A,B,C,D,E,F) :- G+ 1=< 10, G=B, H= 10, new26(A,B,C,D,E,F).
new23(A,B,C,D,E,F) :- G=A, H= 0, I= 0, new5(A,G,J,K,L,M,N,O), 
          new24(L,I,H,D,E,F).
new23(A,B,C,D,E,F) :- G=A, H= 5, I= 5, new7(A,G,J,K,L,M,N,O), 
          new24(L,I,H,D,E,F).
...
new12(A,B,C,D,A,B,C,D) :- E>= 6, E=C, F= 5.
...
new11(A,B,C,D,E,F,G,H) :- I=J- 1, K=B, J= 18446744073709551616+K, K+ 1=< 0, 
          L= 1, M= 5, N= 6, O= 5, P= 1, new7(A,I,Q,R,S,T,U,V), 
          new12(S,B,N,M,E,F,G,H).
new11(A,B,C,D,E,F,G,H) :- I=J- 1, K=B, J= 18446744073709551616+K, K+ 1=< 0, 
...
new11(A,B,C,D,E,F,G,H) :- I=J- 1, K=B, J=K, K>= 0, L= 1, M= 5, N= 6, O= 5, 
...
new10(A,B,C,D,A,B,C,D) :- E=< 5, E=C, F= 5.
...
new9(A,B,C,D,E,F,G,H) :- I=J- 1, K=B, J=K, K>= 0, L= 1, M= 5, N= 6, O= 5, P= 1, 
...
new6(A,B,C,D,E,F) :- G= 10, G=B, H= 10, new13(A,B,C,D,E,F).
new5(A,B,C,D,A,B,C,D) :- E= 0, E=B, F= 0.
new3(A,B,C,D,E,F) :- G=A, H= 0, I= 0, new5(A,G,J,K,L,M,N,O), new6(L,I,H,D,E,F).
new3(A,B,C,D,E,F) :- G=A, H= 5, I= 5, new7(A,G,J,K,L,M,N,O), new6(L,I,H,D,E,F).
