new20(A,B,C,A,B,C).
new18(A,B,C,D,E,F) :- G>= 4, G=B, B>= 0, H= 3, new20(A,B,C,D,E,F).
new18(A,B,C,D,E,F) :- G+ 1=< 3, G=B, B>= 0, H= 3, new20(A,B,C,D,E,F).
...
new6(A,B,C,D,E,F) :- G= 3, G=B, B>= 0, H= 3, new9(A,B,C,D,E,F).
