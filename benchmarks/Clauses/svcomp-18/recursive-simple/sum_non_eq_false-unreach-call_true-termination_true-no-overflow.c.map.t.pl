...
new18(A,B,C,D,E,F,G,H) :- I>=J+ 1, I=C, C>= 0, K=L+M, L=A, M=B, 
          J= 18446744073709551616+K, K+ 1=< 0, new20(A,B,C,D,E,F,G,H).
new18(A,B,C,D,E,F,G,H) :- I+ 1=<J, I=C, C>= 0, K=L+M, L=A, M=B, 
          J= 18446744073709551616+K, K+ 1=< 0, new20(A,B,C,D,E,F,G,H).
new18(A,B,C,D,E,F,G,H) :- I>=J+ 1, I=C, C>= 0, K=L+M, L=A, M=B, J=K, K>= 0, 
          new20(A,B,C,D,E,F,G,H).
new18(A,B,C,D,E,F,G,H) :- I+ 1=<J, I=C, C>= 0, K=L+M, L=A, M=B, J=K, K>= 0, 
          new20(A,B,C,D,E,F,G,H).
...
new6(A,B,C,D,E,F,G,H) :- I=J, I=C, C>= 0, K=L+M, L=A, M=B, 
          J= 18446744073709551616+K, K+ 1=< 0, new9(A,B,C,D,E,F,G,H).
new6(A,B,C,D,E,F,G,H) :- I=J, I=C, C>= 0, K=L+M, L=A, M=B, J=K, K>= 0, 
