new20(A,B,C,A,B,C).
new18(A,B,C,D,E,F) :- G>= 11, G=B, B>= 0, H= 10, new20(A,B,C,D,E,F).
new18(A,B,C,D,E,F) :- G+ 1=< 10, G=B, B>= 0, H= 10, new20(A,B,C,D,E,F).
...
new6(A,B,C,D,E,F) :- G= 10, G=B, B>= 0, H= 10, new9(A,B,C,D,E,F).
