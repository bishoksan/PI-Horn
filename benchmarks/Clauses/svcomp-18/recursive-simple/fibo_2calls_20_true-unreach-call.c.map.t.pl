new46(A,B,C,A,B,C).
new44(A,B,C,D,E,F) :- G= 6765, G=B, H= 6765, new46(A,B,C,D,E,F).
...
new6(A,B,C,D,E,F) :- G>= 6766, G=B, H= 6765, new27(A,B,C,D,E,F).
new6(A,B,C,D,E,F) :- G+ 1=< 6765, G=B, H= 6765, new27(A,B,C,D,E,F).
