...
new9(A,B,C,A,B,C) :- D= 1, E=< 4, E=B, F= 4, new10(A,D,G).
new9(A,B,C,A,B,C) :- D= 0, E>= 5, E=B, F= 4, new10(A,D,G).
...
new3(A,B,C,A,B,C) :- D= 1, E=< 4, E=B, F= 4, new4(A,D,G).
new3(A,B,C,A,B,C) :- D= 0, E>= 5, E=B, F= 4, new4(A,D,G).
