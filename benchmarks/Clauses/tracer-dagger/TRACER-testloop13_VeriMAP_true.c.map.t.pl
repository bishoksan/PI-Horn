new19(A,B,C,D,E,F,G,H) :- I>= 1, I=D, J= 0, K= 0, L=M+ 2, M=C, N= 2, O= 1, 
          new13(O,B,L,D,E,F,G,H).
new19(A,B,C,D,E,F,G,H) :- I+ 1=< 0, I=D, J= 0, K= 0, L=M+ 2, M=C, N= 2, O= 1, 
          new13(O,B,L,D,E,F,G,H).
...
new12(A,B,C,D,E,F,G,H) :- I=J+ 1, J=B, K= 1, new13(A,B,I,D,E,F,G,H).
new10(A,B) :- new12(A,C,D,E,B,F,G,H).
safe :- init(A), new10(A,B).
new9(A,B,C,D,E,F,G,H) :- I>= 1, I=D, J= 0, K= 0, L=M+ 2, M=C, N= 2, O= 1, 
          new3(O,B,L,D,E,F,G,H).
new9(A,B,C,D,E,F,G,H) :- I+ 1=< 0, I=D, J= 0, K= 0, L=M+ 2, M=C, N= 2, O= 1, 
          new3(O,B,L,D,E,F,G,H).
...
new2(A,B,C,D,E,F,G,H) :- I=J+ 1, J=B, K= 1, new3(A,B,I,D,E,F,G,H).
