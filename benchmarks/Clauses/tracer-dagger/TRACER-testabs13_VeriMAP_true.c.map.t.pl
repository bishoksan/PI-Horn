...
new13(A,B,A,B) :- C= 1, D=< 10, D=B, E= 10, new14(A,C,F).
new13(A,B,A,B) :- C= 0, D>= 11, D=B, E= 10, new14(A,C,F).
...
new5(A,B,A,B) :- C= 1, D=< 10, D=B, E= 10, new6(A,C,F).
new5(A,B,A,B) :- C= 0, D>= 11, D=B, E= 10, new6(A,C,F).
