...
new17(A,B,C,D,E,A,B,C,D,E) :- F= 1, G>= 1, G=D, H= 0, new18(A,B,F,I).
new17(A,B,C,D,E,A,B,C,D,E) :- F= 1, G+ 1=< 0, G=D, H= 0, new18(A,B,F,I).
new17(A,B,C,D,E,A,B,C,D,E) :- F= 0, G= 0, G=D, H= 0, new18(A,B,F,I).
...
new7(A,B,C,D,E,A,B,C,D,E) :- F= 1, G>= 1, G=D, H= 0, new8(A,B,F,I).
new7(A,B,C,D,E,A,B,C,D,E) :- F= 1, G+ 1=< 0, G=D, H= 0, new8(A,B,F,I).
new7(A,B,C,D,E,A,B,C,D,E) :- F= 0, G= 0, G=D, H= 0, new8(A,B,F,I).
