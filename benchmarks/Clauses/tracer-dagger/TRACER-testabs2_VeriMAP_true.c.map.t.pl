...
new9(A,B,C,A,B,C) :- D= 1, E= 100, E=B, F= 100, new10(A,D,G).
new9(A,B,C,A,B,C) :- D= 0, E>= 101, E=B, F= 100, new10(A,D,G).
new9(A,B,C,A,B,C) :- D= 0, E+ 1=< 100, E=B, F= 100, new10(A,D,G).
...
new3(A,B,C,A,B,C) :- D= 1, E= 100, E=B, F= 100, new4(A,D,G).
new3(A,B,C,A,B,C) :- D= 0, E>= 101, E=B, F= 100, new4(A,D,G).
new3(A,B,C,A,B,C) :- D= 0, E+ 1=< 100, E=B, F= 100, new4(A,D,G).
