...
new23(A,B,A,B) :- C= 1, D>= 3, D=B, E= 2, new24(A,C,F).
new23(A,B,A,B) :- C= 1, D+ 1=< 2, D=B, E= 2, new24(A,C,F).
new23(A,B,A,B) :- C= 0, D= 2, D=B, E= 2, new24(A,C,F).
...
new20(A,B,C,D) :- E=< 0, E=A, F= 0, G= 2, new21(A,G,C,D).
...
new7(A,B,A,B) :- C= 1, D>= 3, D=B, E= 2, new8(A,C,F).
new7(A,B,A,B) :- C= 1, D+ 1=< 2, D=B, E= 2, new8(A,C,F).
new7(A,B,A,B) :- C= 0, D= 2, D=B, E= 2, new8(A,C,F).
...
new2(A,B,C,D) :- E=< 0, E=A, F= 0, G= 2, new3(A,G,C,D).
