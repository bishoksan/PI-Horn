...
new11(A,B,C,A,B,C) :- D= 1, E>= 1, E=F+G, F=A, G=B, H= 0, new12(A,B,D,I).
new11(A,B,C,A,B,C) :- D= 0, E=< 0, E=F+G, F=A, G=B, H= 0, new12(A,B,D,I).
...
new9(A,B,C,D,E,F) :- G=< 0, G=A, H= 0, I= -1, new10(I,B,C,D,E,F).
new7(A,B,C,D) :- new9(A,B,E,C,D,F).
safe :- init(A,B), new7(A,B,C,D).
new6(A,B,C,C).
new5(A,B,C,D) :- E= 0, E=C, F= 0, new6(A,B,C,D).
new4(A,B,C,A,B,C) :- D= 1, E>= 1, E=F+G, F=A, G=B, H= 0, new5(A,B,D,I).
new4(A,B,C,A,B,C) :- D= 0, E=< 0, E=F+G, F=A, G=B, H= 0, new5(A,B,D,I).
...
new2(A,B,C,D,E,F) :- G=< 0, G=A, H= 0, I= -1, new3(I,B,C,D,E,F).
