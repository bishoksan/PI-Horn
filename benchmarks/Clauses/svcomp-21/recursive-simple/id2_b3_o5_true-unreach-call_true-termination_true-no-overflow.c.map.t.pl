new38(A,B,C,A,B,C).
new36(A,B,C,D,E,F) :- G>= 6, G=B, B>= 0, H= 5, new38(A,B,C,D,E,F).
new36(A,B,C,D,E,F) :- G+ 1=< 5, G=B, B>= 0, H= 5, new38(A,B,C,D,E,F).
new35(A,B,C,D,E,F) :- G=A, A>= 0, H= 0, I= 0,  0>= 0, new5(A,G,J,K,L,M,N,O), 
          new36(L,I,H,D,E,F).
new35(A,B,C,D,E,F) :- G=A, A>= 0, H= 3, I= 3,  3>= 0, new7(A,G,J,K,L,M,N,O), 
          new36(L,I,H,D,E,F).
...
new11(A,B,C,D,A,B,C,D) :- E=< 3, E=C, C>= 0, F= 3.
...
new9(A,B,C,D,E,F,G,H) :- I=J- 1, J=B, B>= 0, K= 1, L= 3, M= 4, N= 3,  3>= 0, 
...
new6(A,B,C,D,E,F) :- G= 5, G=B, B>= 0, H= 5, new22(A,B,C,D,E,F).
new5(A,B,C,D,A,B,C,D) :- E= 0, E=B, B>= 0, F= 0.
new3(A,B,C,D,E,F) :- G=A, A>= 0, H= 0, I= 0,  0>= 0, new5(A,G,J,K,L,M,N,O), 
          new6(L,I,H,D,E,F).
new3(A,B,C,D,E,F) :- G=A, A>= 0, H= 3, I= 3,  3>= 0, new7(A,G,J,K,L,M,N,O), 
          new6(L,I,H,D,E,F).
