new46(A,B,C,A,B,C).
new44(A,B,C,D,E,F) :- G= 75025, G=B, H= 75025, new46(A,B,C,D,E,F).
...
new6(A,B,C,D,E,F) :- G>= 75026, G=B, H= 75025, new27(A,B,C,D,E,F).
new6(A,B,C,D,E,F) :- G+ 1=< 75025, G=B, H= 75025, new27(A,B,C,D,E,F).
