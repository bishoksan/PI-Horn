new20(A,B,C,A,B,C).
new18(A,B,C,D,E,F) :- G>= 1001, G=B, B>= 0, H= 1000, new20(A,B,C,D,E,F).
new18(A,B,C,D,E,F) :- G+ 1=< 1000, G=B, B>= 0, H= 1000, new20(A,B,C,D,E,F).
...
new6(A,B,C,D,E,F) :- G= 1000, G=B, B>= 0, H= 1000, new9(A,B,C,D,E,F).
