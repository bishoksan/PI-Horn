new38(A,B,C,A,B,C).
new36(A,B,C,D,E,F) :- G>= 3, G=B, B>= 0, H= 2, new38(A,B,C,D,E,F).
new36(A,B,C,D,E,F) :- G+ 1=< 2, G=B, B>= 0, H= 2, new38(A,B,C,D,E,F).
...
new6(A,B,C,D,E,F) :- G= 2, G=B, B>= 0, H= 2, new22(A,B,C,D,E,F).
