new38(A,B,C,A,B,C).
new36(A,B,C,D,E,F) :- G>= 4, G=B, B>= 0, H= 3, new38(A,B,C,D,E,F).
new36(A,B,C,D,E,F) :- G+ 1=< 3, G=B, B>= 0, H= 3, new38(A,B,C,D,E,F).
new35(A,B,C,D,E,F) :- G=A, A>= 0, H= 0, I= 0,  0>= 0, new5(A,G,J,K,L,M,N,O), 
          new36(L,I,H,D,E,F).
new35(A,B,C,D,E,F) :- G=A, A>= 0, H= 2, I= 2,  2>= 0, new7(A,G,J,K,L,M,N,O), 
          new36(L,I,H,D,E,F).
...
new11(A,B,C,D,A,B,C,D) :- E=< 2, E=C, C>= 0, F= 2.
...
new6(A,B,C,D,E,F) :- G= 3, G=B, B>= 0, H= 3, new22(A,B,C,D,E,F).
