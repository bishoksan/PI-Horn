new20(A,B,C,A,B,C).
new18(A,B,C,D,E,F) :- G>= 21, G=B, B>= 0, H= 20, new20(A,B,C,D,E,F).
new18(A,B,C,D,E,F) :- G+ 1=< 20, G=B, B>= 0, H= 20, new20(A,B,C,D,E,F).
...
new6(A,B,C,D,E,F) :- G= 20, G=B, B>= 0, H= 20, new9(A,B,C,D,E,F).
