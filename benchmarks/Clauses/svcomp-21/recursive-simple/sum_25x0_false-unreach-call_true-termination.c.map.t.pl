...
new18(A,B,C,D,E,F,G,H) :- I>=J+ 1, I=C, J=K+L, K=A, L=B, new20(A,B,C,D,E,F,G,H).
new18(A,B,C,D,E,F,G,H) :- I+ 1=<J, I=C, J=K+L, K=A, L=B, new20(A,B,C,D,E,F,G,H).
new17(A,B,C,D,E,F,G,H) :- I=A, J=B, K=L+M, L=N, M=O, P=K, 
          new5(A,B,I,J,Q,R,S,O,N,T), new18(R,S,P,K,E,F,G,H).
...
new8(A,B,C,D,E,F,G,C,D,H) :- I=J- 1, J=C, K= 1, L=M+ 1, M=D, N= 1, H=O+P, O=Q, 
          P=R, new5(A,B,I,L,S,F,G,R,Q,T).
...
new6(A,B,C,D,E,F,G,H) :- I=J, I=C, J=K+L, K=A, L=B, new9(A,B,C,D,E,F,G,H).
new5(A,B,C,D,E,A,B,C,D,E) :- F=< 0, F=C, G= 0.
new3(A,B,C,D,E,F,G,H) :- I=A, J=B, K=L+M, L=N, M=O, P=K, 
          new5(A,B,I,J,Q,R,S,O,N,T), new6(R,S,P,K,E,F,G,H).
