new46(A,B,C,A,B,C).
new44(A,B,C,D,E,F) :- G>= 611, G=B, H= 610, new46(A,B,C,D,E,F).
new44(A,B,C,D,E,F) :- G+ 1=< 610, G=B, H= 610, new46(A,B,C,D,E,F).
...
new6(A,B,C,D,E,F) :- G= 610, G=B, H= 610, new27(A,B,C,D,E,F).
