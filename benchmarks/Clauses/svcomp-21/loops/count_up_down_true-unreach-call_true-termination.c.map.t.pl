...
new15(A,B,C,A,B,C) :- D= 1, E=F, E=C, C>= 0, F=A, A>= 0, new16(A,B,D,G).
new15(A,B,C,A,B,C) :- D= 0, E>=F+ 1, E=C, C>= 0, F=A, A>= 0, new16(A,B,D,G).
new15(A,B,C,A,B,C) :- D= 0, E+ 1=<F, E=C, C>= 0, F=A, A>= 0, new16(A,B,D,G).
...
new5(A,B,C,A,B,C) :- D= 1, E=F, E=C, C>= 0, F=A, A>= 0, new6(A,B,D,G).
new5(A,B,C,A,B,C) :- D= 0, E>=F+ 1, E=C, C>= 0, F=A, A>= 0, new6(A,B,D,G).
new5(A,B,C,A,B,C) :- D= 0, E+ 1=<F, E=C, C>= 0, F=A, A>= 0, new6(A,B,D,G).
