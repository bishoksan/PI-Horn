...
new20(A,B,C,D,E,F,G,H) :- I+ 1=<J, I=C, J=K* 2, K=A, L= 2, 
          new22(A,B,C,D,E,F,G,H).
new19(A,B,C,D,E,F,G,H) :- I+ 1=< 10, I=B, J= 10, K=L+ 2, L=C, M= 2, 
          new26(A,B,K,D,E,F,G,H).
new19(A,B,C,D,E,F,G,H) :- I>= 10, I=B, J= 10, new26(A,B,C,D,E,F,G,H).
...
new5(A,B,C,D,E,F,G,H) :- I+ 1=< 10, I=B, J= 10, K=L+ 2, L=C, M= 2, 
          new13(A,B,K,D,E,F,G,H).
new5(A,B,C,D,E,F,G,H) :- I>= 10, I=B, J= 10, new13(A,B,C,D,E,F,G,H).
