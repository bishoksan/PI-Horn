...
new29(A,B,C,D,E,F) :- G>= 102, G=A, H= 101, new30(A,B,C,D,E,F).
...
new10(A,B,C,D,E,F) :- G>= 102, G=A, H= 101, new11(A,B,C,D,E,F).
new10(A,B,C,D,E,F) :- G=< 101, G=A, H= 101, new12(A,B,C,D,E,F).
