...
new16(A,B,C,D) :- E+1=<F, E=:=B, F=:=0, new17(A,B,C,D).
new16(A,B,C,D) :- E>=F, E=:=B, F=:=0, G=:=H+I, H=:=A, I=:=1, new14(G,B,C,D).
new15(A,B,C,D) :- E+1=<F, E=:=A, F=:=50, G=:=H+I, H=:=B, I=:=1, new16(A,G,C,D).
new15(A,B,C,D) :- E>=F, E=:=A, F=:=50, G=:=H-I, H=:=B, I=:=1, new16(A,G,C,D).
...
new5(A,B,C,D) :- E+1=<F, E=:=B, F=:=0, new6(A,B,C,D).
new5(A,B,C,D) :- E>=F, E=:=B, F=:=0, G=:=H+I, H=:=A, I=:=1, new3(G,B,C,D).
new4(A,B,C,D) :- E+1=<F, E=:=A, F=:=50, G=:=H+I, H=:=B, I=:=1, new5(A,G,C,D).
new4(A,B,C,D) :- E>=F, E=:=A, F=:=50, G=:=H-I, H=:=B, I=:=1, new5(A,G,C,D).
