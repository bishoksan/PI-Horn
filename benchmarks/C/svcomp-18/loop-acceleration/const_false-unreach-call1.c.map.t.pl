...
new15(A,B,A,B) :- C= 1, D= 1, D=A, A>= 0, E= 1, new16(A,B,C,F).
new15(A,B,A,B) :- C= 0, D>= 2, D=A, A>= 0, E= 1, new16(A,B,C,F).
new15(A,B,A,B) :- C= 0, D+ 1=< 1, D=A, A>= 0, E= 1, new16(A,B,C,F).
...
new5(A,B,A,B) :- C= 1, D= 1, D=A, A>= 0, E= 1, new6(A,B,C,F).
new5(A,B,A,B) :- C= 0, D>= 2, D=A, A>= 0, E= 1, new6(A,B,C,F).
new5(A,B,A,B) :- C= 0, D+ 1=< 1, D=A, A>= 0, E= 1, new6(A,B,C,F).
